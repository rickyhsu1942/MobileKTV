...
-(UIImage *) audioImageLogGraph:(Float32 *) samples
              ...
              imageWidthLimited:(NSInteger) imageWidthLimited{
    
    CGSize imageSize;
//    if (sampleCount > imageWidthLimited)
//        imageSize = CGSizeMake(sampleCount, imageHeight);
//    else
        imageSize = CGSizeMake(sampleCount / 4, imageHeight);
    ...
    rect.origin.x = 0;
    rect.origin.y = 0;
    CGColorRef leftcolor = [[UIColor colorWithRed:100/255.0 green:255/255.0 blue:100/255.0 alpha:1] CGColor];
...
//    float centerRight = (halfGraphHeight*3) ;
    ...
    for (float intSample = 0 ; intSample < sampleCount / 4; intSample +=0.25 ) {
        Float32 left = *samples++;
//        float pixels = (left - noiseFloor) * (sampleAdjustmentFactor);
        float pixels = (left - noiseFloor) * (sampleAdjustmentFactor +0.75);
